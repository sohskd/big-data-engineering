...
public class StudentRegistrationWriteCsvPerWindow extends PTransform<PCollection<String>, PDone> {
    private static final DateTimeFormatter FORMATTER = ISODateTimeFormat.hourMinute();
    private String filenamePrefix;
    @Nullable
    private Integer numShards;

    public StudentRegistrationWriteCsvPerWindow(String filenamePrefix, Integer numShards) {
    ...
    public PDone expand(PCollection<String> input) {
        ...
        TextIO.Write write = TextIO.write()
                ...
                .withWindowedWrites()
                .withHeader("code_module,code_presentation,id_student,date_registration,date_unregistration");
        ...
        PCollection<String> csvStrings = input.apply("Convert to CSV", ParDo.of(new DoFn<String, String>() {
            ...
            public void processElement(ProcessContext processContext) {
                ...
                String d = json.getString("dateRegistration");
                String e = json.getString("dateUnregistration");

                String csvString = String.format("%s,%s,%s,%s,%s", a, b, c, d, e);
